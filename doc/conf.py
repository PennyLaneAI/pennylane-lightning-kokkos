...
# -*- coding: utf-8 -*-
#
# PennyLane-Lightning-Kokkos documentation build configuration file.
#
...
MOCK_MODULES = ["pennylane_lightning_kokkos.lightning_kokkos_qubit_ops", "ctypes.util"]
...
# Breathe extension
breathe_projects = {"PennyLane-Lightning-Kokkos": "./doxyoutput/xml"}
breathe_default_project = "PennyLane-Lightning-Kokkos"
...
exhale_args = {
    ...
    "exhaleDoxygenStdin": (
        "INPUT = "
        "../pennylane_lightning_kokkos/src/simulator/StateVectorKokkos.hpp "
        "../pennylane_lightning_kokkos/src/algorithms/AdjointDiffKokkos.hpp "
        "EXCLUDE_SYMBOLS = std::* "
    ),
    "afterTitleDescription": inspect.cleandoc(
        """
        The Pennylane-Lightning-Kokkos C++ API is intended to be called from Python through Pybind11. Direct use of the C++ API is currently unsupported and is provided for reference only.
        """
    ),
}
...
release = pennylane_lightning_kokkos.__version__
...
html_theme_options = {
    ...
    "navbar_right_links": [
        ...
        {
            "name": "GitHub",
            "href": "https://github.com/PennyLaneAI/pennylane-lightning-kokkos",
            "icon": "fab fa-github",
        }
    ],
